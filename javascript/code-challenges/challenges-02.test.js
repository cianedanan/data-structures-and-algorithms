...
const addQuestion = (arr) => {
  const newArr = arr.map(string => string + '?');
  return newArr;
};
...
const charCode = (arr) => {
  const newArr = arr.map(element => element.charCodeAt(0));
  return newArr;
};
...
const extractAbilities = (arr) => {
  const newArr = arr.map(stats => stats.ability.name);
  return newArr;
};
...
const extractStats = (arr) => {
  const newArr = arr.map(stat => stat.name = stat.stat.name );
  return newArr;
};
